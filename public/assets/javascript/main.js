...
window.addEventListener('DOMContentLoaded', async () => {
	...
	let inc = display_incidents(map, incidents)
	...
	let perim = display_perimeters(map, perimeters)
	...
	let firms_layer = display_firms(map, firms)
...
let display_incidents = (map, incidents) => {
	let smallMarkerOptions = {
		radius: 6,
		fillColor: "#ff7800",
		color: "#000",
...
let display_perimeters = (map, perimeters) => {
	let perim = L.geoJSON(perimeters, {
		style: function(_) {
			return { color: "#7777ff" }
		}
